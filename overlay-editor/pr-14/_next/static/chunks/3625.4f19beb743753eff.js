...
`,ei=!1;function es(){if("u"<typeof document||ei)return;ei=!0;let e=document.createElement("style");e.dataset.overlayEditor="overlay-card-view",e.textContent=eo,document.head.appendChild(e)}function el({content:e,className:t}){return(0,n.useEffect)(es,[]),(0,n.useEffect)(()=>{void 0!==e&&u.getState().setRawJson(e)},[e]),(0,a.jsx)("div",{className:t,children:(0,a.jsx)(en,{})})}var ec=r(90334);function ed({overlays:e,selectedId:t,onSelect:r}){let[o,s]=(0,n.useState)(""),l=(0,n.useMemo)(()=>{let t=o.trim().toLowerCase();return t?e.filter(e=>e.title.toLowerCase().includes(t)||e.description.toLowerCase().includes(t)||e.targetType.toLowerCase().includes(t)):e},[e,o]);return(0,a.jsxs)("div",{className:"flex h-full min-h-0 flex-col",children:[(0,a.jsx)("div",{className:"shrink-0 border-b border-border p-3",children:(0,a.jsxs)("div",{className:"relative",children:[(0,a.jsx)(D.A,{className:"pointer-events-none absolute left-2 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground"}),(0,a.jsx)(i.pd,{value:o,onChange:e=>s(e.target.value),placeholder:"Search examples…",className:"pl-8"})]})}),(0,a.jsx)("div",{className:"flex-1 overflow-y-auto p-2",children:0===l.length?(0,a.jsxs)("p",{className:"px-2 py-4 text-center text-xs text-muted-foreground",children:["No examples match “",o,"”."]}):(0,a.jsx)("ul",{className:"flex flex-col gap-2",children:l.map(e=>{var n;return(0,a.jsx)("li",{children:(0,a.jsxs)(i.Zp,{role:"button",tabIndex:0,onClick:()=>r(e),onKeyDown:t=>{("Enter"===t.key||" "===t.key)&&(t.preventDefault(),r(e))},className:(0,i.cn)("cursor-pointer transition-colors hover:border-primary/40 hover:bg-accent/30",t===e.id&&"border-primary/60 bg-accent/40"),children:[(0,a.jsx)(i.Zp.Header,{className:"p-3",children:(0,a.jsxs)("div",{className:"flex items-start justify-between gap-2",children:[(0,a.jsx)(i.Zp.Title,{className:"text-sm leading-tight",children:e.title}),(0,a.jsx)(i.Ex,{variant:"secondary",className:"shrink-0 text-[10px] uppercase",children:(n=e.targetType).startsWith("openapi")?"OpenAPI":n.startsWith("csn")?"CSN":n.startsWith("edmx")?"EDMX":n.startsWith("mcp")?"MCP":n.startsWith("a2a")?"A2A":n})]})}),(0,a.jsx)(i.Zp.Content,{className:"px-3 pb-3 pt-0",children:(0,a.jsx)("p",{className:"line-clamp-2 text-xs text-muted-foreground",children:e.description})})]})},e.id)})})})]})}var ep=r(92571);let em="example";function ey(){let e=(0,o.useRouter)(),t=(0,o.useSearchParams)(),r=t.get(em),[s,l]=(0,n.useState)([]),[c,d]=(0,n.useState)(""),[m,y]=(0,n.useState)(!0),[h,u]=(0,n.useState)(null);(0,n.useEffect)(()=>{let e=!0;return(0,ec.W)().then(t=>{e&&l(t)}).catch(t=>{e&&(u(String(t)),y(!1))}),()=>{e=!1}},[]);let v=(0,n.useMemo)(()=>0===s.length?null:r&&s.find(e=>e.id===r)||s[0],[s,r]),f=v?.url??null;(0,n.useEffect)(()=>{if(!f)return;let e=!0;return queueMicrotask(()=>{e&&(y(!0),u(null))}),(0,ec.l)(f).then(t=>{e&&(d(t),y(!1))}).catch(t=>{e&&(u(String(t)),y(!1))}),()=>{e=!1}},[f]);let g=(0,n.useCallback)(r=>{let a=new URLSearchParams(t.toString());a.set(em,r.id),e.replace(`?${a.toString()}`,{scroll:!1})},[e,t]);return(0,a.jsxs)(i.vh.Root,{orientation:"horizontal",autoSaveId:"overlay-view-playground",className:"flex h-full min-h-0 flex-1",children:[(0,a.jsx)(i.vh.Panel,{defaultSize:"22%",minSize:"16%",maxSize:"40%",children:(0,a.jsx)(ed,{overlays:s,selectedId:v?.id??null,onSelect:g})}),(0,a.jsx)(i.vh.Handle,{}),(0,a.jsx)(i.vh.Panel,{defaultSize:"38%",minSize:"20%",children:(0,a.jsx)(p,{value:c,onChange:e=>d(e??""),language:"json",height:"100%"})}),(0,a.jsx)(i.vh.Handle,{}),(0,a.jsx)(i.vh.Panel,{defaultSize:"40%",minSize:"20%",children:(0,a.jsx)("div",{className:"relative h-full min-h-0 overflow-auto",children:m?(0,a.jsx)("div",{className:"grid h-full place-items-center text-sm text-muted-foreground",children:(0,a.jsxs)("span",{className:"inline-flex items-center gap-2",children:[(0,a.jsx)(ep.A,{className:"h-4 w-4 animate-spin"}),"Loading overlay…"]})}):h?(0,a.jsx)("div",{className:"grid h-full place-items-center p-6 text-center",children:(0,a.jsxs)("div",{children:[(0,a.jsx)("p",{className:"text-sm font-medium text-destructive",children:"Failed to load overlay."}),(0,a.jsx)("p",{className:"mt-1 text-xs text-muted-foreground",children:h}),(0,a.jsx)(i.$n,{variant:"outline",size:"sm",className:"mt-4",onClick:()=>e.refresh(),children:"Retry"})]})}):(0,a.jsx)(el,{content:c})})})]})}},90334:(e,t,r)=>{function a(e){return e.startsWith("/")?`/pr-preview/overlay-editor/pr-14${e}`:e}r.d(t,{W:()=>i,l:()=>s});let n=a("/predefined-overlays.json"),o=null;function i(){return o||(o=fetch(n).then(e=>{if(!e.ok)throw Error(`failed to fetch ${n}: ${e.status}`);return e.json()}).catch(e=>{throw o=null,e})),o}async function s(e){let t=a(e),r=await fetch(t);if(!r.ok)throw Error(`failed to fetch ${t}: ${r.status}`);return r.text()}}}]);
...
}`,`${P} .rounded:not(.inline-block) { overflow: hidden; }`,`${P} .rounded-tl-none { border-top-left-radius: 0px; }`),D.join("\n")):null,T=(0,s.useMemo)(()=>r??[],[r]),R=void 0!==r,I=(0,s.useMemo)(()=>R?(0,t.i)(e):null,[e,R]),L=(0,s.useMemo)(()=>"string"==typeof I?.asyncapi?I.asyncapi:"",[I]),W=(0,s.useMemo)(()=>{if(!R)return a??{};let e=function(e,a,r){if(c.version=r,c.configs=e,a){let r=e.map(e=>e.prefixStartsWith).filter(Boolean);c.rootFields=r.length?function(e,a){let r={};for(let[t,s]of Object.entries(e))!g.has(t)&&t.startsWith("x-")&&a.some(e=>t.startsWith(e))&&(r[t]=s);return r}(a,r):{}}else c.rootFields={};let t={};for(let r of e){for(let[e,a]of Object.entries(r.extensions??{}))t[e]=v(e,a,r);if(r.prefixStartsWith&&a)for(let e of function(e,a){let r=new Set,t=e=>{if(e&&"object"==typeof e)for(let t of Object.keys(e))t.startsWith(a)&&r.add(t)};t(e),t(e.info);let s=e.channels;if(s)for(let e of Object.values(s)){if(!e||"object"!=typeof e)continue;for(let a of(t(e),["subscribe","publish","send","receive"])){let r=e[a];r&&"object"==typeof r&&(t(r),t(r.message))}let a=e.messages;if(a)for(let e of Object.values(a))t(e)}let n=e.operations;if(n)for(let e of Object.values(n))t(e);let o=e.components;if(o){for(let e of["messages","messageTraits"]){let a=o[e];if(a)for(let e of Object.values(a))t(e)}let e=o.schemas;if(e)for(let a of Object.values(e))t(a);let a=o.channels;if(a)for(let e of Object.values(a))t(e);let r=o.operations;if(r)for(let e of Object.values(r))t(e)}return[...r]}(a,r.prefixStartsWith))t[e]||(t[e]=v(e,void 0,r))}return t}(T,I,L);return{...a,extensions:{...e,...a?.extensions??{}}}},[a,R,T,I,L]),_=(0,s.useMemo)(()=>R?function(e){function a(a){let r=Object.entries(c.rootFields);if(!r.length)return null;let t=r.flatMap(([a,r])=>{let t=c.configs.find(e=>e.extensions?.[a])??c.configs.find(e=>e.prefixStartsWith&&a.startsWith(e.prefixStartsWith))??e[0];if(!t)return[];let n=t.extensions?.[a];return[(0,s.createElement)(v(a,n,t),{key:a,propertyName:a,propertyValue:r,document:void 0,parent:void 0})]});return t.length?(0,s.createElement)("div",null,...t):null}return{name:"sap-root-extensions",version:"1.0.0",install(e){e.registerComponent(l.WN.INFO,a)}}}(T):null,[R,T]),B=`[data-renderer-id="${E}"]`,U=`${B} { container: asyncapi-attrs / inline-size; height: 100%; overflow: auto; scrollbar-gutter: stable; }
${B} :where(h1,h2,h3,h4,p,span,strong,a,li,td,div):not(pre *) { overflow-wrap: anywhere; }`;return(0,o.jsxs)("div",{"data-renderer-id":E,className:n,children:[M&&(0,o.jsx)("style",{children:M}),R&&(0,o.jsx)("style",{children:j}),(0,o.jsx)("style",{children:U}),R&&(0,o.jsx)("style",{children:`[data-renderer-id="${E}"] #introduction .hidden { display: block !important; }`}),!R&&(0,o.jsx)("style",{children:`[data-renderer-id="${E}"] :is(#operations, #messages) div:has(> .flex.py-2 span.Extensions) { display: none; }`}),(0,o.jsx)(i,{schema:e,config:W,plugins:_?[_]:[]})]})}},64017(e,a,r){"use strict";r.d(a,{t:()=>p});var t=r(92810),s=r(96540),n=r(74848),o=r(90580),i=`
.csn-root {

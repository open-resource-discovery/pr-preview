...
${h}
}`].filter(Boolean).join("\n\n"))}),(0,i.jsx)(n.B,{configuration:v},`${m?"dark":"light"}-${x}-${g}`)]})}},13983(e,a,t){"use strict";t.d(a,{t:()=>i});var r=t(92810),s=t(96540),n=t(74848),o=t(54128);function i({content:e,className:a,theme:t}){let l=(0,s.useId)(),{setTheme:c}=(0,o.r)(),d=a?.split(/\s+/).includes("dark")??!1;(0,s.useEffect)(()=>{o.s.getState().setRawJson(e)},[e]),(0,s.useEffect)(()=>{c(d?"dark":"light")},[d,c]);let p=t?(0,r.t)("overlay-root",l,t):null,u=t?(0,r.t)("overlay-sidebar-footer-mobile",l,t):null,h=`

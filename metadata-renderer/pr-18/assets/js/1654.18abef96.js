...
`,j={"--ord-background":"#1e1e1e","--ord-foreground":"#d4d4d4","--ord-card":"#252526","--ord-primary":"#0098ff","--ord-primary-foreground":"#1e1e1e","--ord-muted":"#2d2d30","--ord-muted-foreground":"#969696","--ord-border":"#3e3e42"};function S({content:e,config:a,customAttributes:t,className:n,theme:c}){let d,p,u,h,b,f,m,y,k,w,N,A,O,D,P=(0,s.useId)(),E=n?.split(/\s+/).includes("dark")??!1,$=c??(E?j:null),C=$?(d=$["--ord-background"],p=$["--ord-foreground"],u=$["--ord-secondary"],h=$["--ord-secondary-foreground"],b=$["--ord-muted"],f=$["--ord-muted-foreground"],m=$["--ord-border"],y=$["--ord-primary"],k=$["--ord-primary-foreground"],w=$["--ord-accent"],N=$["--ord-accent-foreground"],A=$["--ord-radius"],O=[],D=`[data-renderer-id="${P}"]`,d&&O.push(`${D} .bg-white { background-color: ${d} !important; }`),p&&O.push(`${D} {color: ${p}; }`),w&&N&&O.push(`${D} .bg-blue-100 { color: ${N}; background-color: ${w}; }`),u&&O.push(`${D} .bg-gray-100 { background-color: ${u} !important; }`),h&&O.push(`${D} .prose, ${D} .text-gray-700 { color: ${h}; }`),b&&O.push(`${D} .bg-gray-200 { background-color: ${b} !important; }`),f&&O.push(`${D} .text-gray-500, ${D} .text-gray-600 { color: ${f} !important; }`),y&&O.push(`${D} .bg-gray-800 { background-color: ${y} !important; }`,`${D} .bg-blue-100 .text-purple-700 { color: ${y}; }`),k&&O.push(`${D} .text-white { color: ${k} !important; }`),u&&O.push(`${D} .bg-gray-400 { background-color: ${u} !important; }`),N&&O.push(`${D} .text-gray-200, ${D} .examples .text-gray-600 { color: ${N} !important; } `),p&&O.push(`${D} .text-gray-800, ${D} .text-gray-900 { color: ${p} !important; }`),m&&O.push(`${D} .border { border-color: ${m}; }`,`${D} .border-b { border-bottom-color: ${m}; }`,`${D} .border-gray-400 { border-color: ${m} !important; }`),A&&O.push(`${D} .rounded, ${D} .prose pre { border-radius: ${A}px; }`,`@media (min-width: 1536px) {
${D} .\\32 xl\\:rounded { border-radius: ${A}px; }
}`,`${D} .rounded:not(.inline-block) { overflow: hidden; }`,`${D} .rounded-tl-none { border-top-left-radius: 0px; }`),O.join("\n")):null,M=(0,s.useMemo)(()=>t??[],[t]),T=void 0!==t,R=(0,s.useMemo)(()=>T?(0,r.i)(e):null,[e,T]),I=(0,s.useMemo)(()=>"string"==typeof R?.asyncapi?R.asyncapi:"",[R]),L=(0,s.useMemo)(()=>{if(!T)return a??{};let e=function(e,a,t){if(l.version=t,l.configs=e,a){let t=e.map(e=>e.prefixStartsWith).filter(Boolean);l.rootFields=t.length?function(e,a){let t={};for(let[r,s]of Object.entries(e))!g.has(r)&&r.startsWith("x-")&&a.some(e=>r.startsWith(e))&&(t[r]=s);return t}(a,t):{}}else l.rootFields={};let r={};for(let t of e){for(let[e,a]of Object.entries(t.extensions??{}))r[e]=x(e,a,t);if(t.prefixStartsWith&&a)for(let e of function(e,a){let t=new Set,r=e=>{if(e&&"object"==typeof e)for(let r of Object.keys(e))r.startsWith(a)&&t.add(r)};r(e),r(e.info);let s=e.channels;if(s)for(let e of Object.values(s)){if(!e||"object"!=typeof e)continue;for(let a of(r(e),["subscribe","publish","send","receive"])){let t=e[a];t&&"object"==typeof t&&(r(t),r(t.message))}let a=e.messages;if(a)for(let e of Object.values(a))r(e)}let n=e.operations;if(n)for(let e of Object.values(n))r(e);let o=e.components;if(o){for(let e of["messages","messageTraits"]){let a=o[e];if(a)for(let e of Object.values(a))r(e)}let e=o.schemas;if(e)for(let a of Object.values(e))r(a);let a=o.channels;if(a)for(let e of Object.values(a))r(e);let t=o.operations;if(t)for(let e of Object.values(t))r(e)}return[...t]}(a,t.prefixStartsWith))r[e]||(r[e]=x(e,void 0,t))}return r}(M,R,I);return{...a,extensions:{...e,...a?.extensions??{}}}},[a,T,M,R,I]),W=(0,s.useMemo)(()=>T?function(e){function a(a){let t=Object.entries(l.rootFields);if(!t.length)return null;let r=t.flatMap(([a,t])=>{let r=l.configs.find(e=>e.extensions?.[a])??l.configs.find(e=>e.prefixStartsWith&&a.startsWith(e.prefixStartsWith))??e[0];if(!r)return[];let n=r.extensions?.[a];return[(0,s.createElement)(x(a,n,r),{key:a,propertyName:a,propertyValue:t,document:void 0,parent:void 0})]});return r.length?(0,s.createElement)("div",null,...r):null}return{name:"sap-root-extensions",version:"1.0.0",install(e){e.registerComponent(i.PluginSlot.INFO,a)}}}(M):null,[T,M]),_=`[data-renderer-id="${P}"]`,B=`${_} { container: asyncapi-attrs / inline-size; height: 100%; overflow: auto; scrollbar-gutter: stable; }
${_} :where(h1,h2,h3,h4,p,span,strong,a,li,td,div):not(pre *) { overflow-wrap: anywhere; }`;return(0,o.jsxs)("div",{"data-renderer-id":P,className:n,children:[C&&(0,o.jsx)("style",{children:C}),T&&(0,o.jsx)("style",{children:v}),(0,o.jsx)("style",{children:B}),T&&(0,o.jsx)("style",{children:`[data-renderer-id="${P}"] #introduction .hidden { display: block !important; }`}),!T&&(0,o.jsx)("style",{children:`[data-renderer-id="${P}"] :is(#operations, #messages) div:has(> .flex.py-2 span.Extensions) { display: none; }`}),(0,o.jsx)(i,{schema:e,config:L,plugins:W?[W]:[]})]})}},64017(e,a,t){"use strict";t.d(a,{t:()=>p});var r=t(92810),s=t(96540),n=t(74848),o=t(90580),i=`
.csn-root {

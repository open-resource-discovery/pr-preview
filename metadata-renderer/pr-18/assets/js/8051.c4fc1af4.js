...
`,j={"--ord-background":"#1e1e1e","--ord-foreground":"#d4d4d4","--ord-card":"#252526","--ord-primary":"#0098ff","--ord-primary-foreground":"#1e1e1e","--ord-muted":"#2d2d30","--ord-muted-foreground":"#969696","--ord-border":"#3e3e42"};function k({content:e,config:r,customAttributes:t,className:o,theme:c}){let d,p,u,f,b,h,m,y,S,w,N,A,O,D,P=(0,n.useId)(),$=o?.split(/\s+/).includes("dark")??!1,E=c??($?j:null),M=E?(d=E["--ord-background"],p=E["--ord-foreground"],u=E["--ord-secondary"],f=E["--ord-secondary-foreground"],b=E["--ord-muted"],h=E["--ord-muted-foreground"],m=E["--ord-border"],y=E["--ord-primary"],S=E["--ord-primary-foreground"],w=E["--ord-accent"],N=E["--ord-accent-foreground"],A=E["--ord-radius"],O=[],D=`[data-renderer-id="${P}"]`,d&&O.push(`${D} .bg-white { background-color: ${d} !important; }`),p&&O.push(`${D} {color: ${p}; }`),w&&N&&O.push(`${D} .bg-blue-100 { color: ${N}; background-color: ${w}; }`),u&&O.push(`${D} .bg-gray-100 { background-color: ${u} !important; }`),f&&O.push(`${D} .prose, ${D} .text-gray-700 { color: ${f}; }`),b&&O.push(`${D} .bg-gray-200 { background-color: ${b} !important; }`),h&&O.push(`${D} .text-gray-500, ${D} .text-gray-600 { color: ${h} !important; }`),y&&O.push(`${D} .bg-gray-800 { background-color: ${y} !important; }`,`${D} .bg-blue-100 .text-purple-700 { color: ${y}; }`),S&&O.push(`${D} .text-white { color: ${S} !important; }`),u&&O.push(`${D} .bg-gray-400 { background-color: ${u} !important; }`),N&&O.push(`${D} .text-gray-200, ${D} .examples .text-gray-600 { color: ${N} !important; } `),p&&O.push(`${D} .text-gray-800, ${D} .text-gray-900 { color: ${p} !important; }`),m&&O.push(`${D} .border { border-color: ${m}; }`,`${D} .border-b { border-bottom-color: ${m}; }`,`${D} .border-gray-400 { border-color: ${m} !important; }`),A&&O.push(`${D} .rounded, ${D} .prose pre { border-radius: ${A}px; }`,`@media (min-width: 1536px) {
${D} .\\32 xl\\:rounded { border-radius: ${A}px; }
}`,`${D} .rounded:not(.inline-block) { overflow: hidden; }`,`${D} .rounded-tl-none { border-top-left-radius: 0px; }`),O.join("\n")):null,C=(0,n.useMemo)(()=>t??[],[t]),T=void 0!==t,R=(0,n.useMemo)(()=>T?(0,a.i)(e):null,[e,T]),I=(0,n.useMemo)(()=>"string"==typeof R?.asyncapi?R.asyncapi:"",[R]),W=(0,n.useMemo)(()=>{if(!T)return r??{};let e=function(e,r,t){if(l.version=t,l.configs=e,r){let t=e.map(e=>e.prefixStartsWith).filter(Boolean);l.rootFields=t.length?function(e,r){let t={};for(let[a,n]of Object.entries(e))!g.has(a)&&a.startsWith("x-")&&r.some(e=>a.startsWith(e))&&(t[a]=n);return t}(r,t):{}}else l.rootFields={};let a={};for(let t of e){for(let[e,r]of Object.entries(t.extensions??{}))a[e]=x(e,r,t);if(t.prefixStartsWith&&r)for(let e of function(e,r){let t=new Set,a=e=>{if(e&&"object"==typeof e)for(let a of Object.keys(e))a.startsWith(r)&&t.add(a)};a(e),a(e.info);let n=e.channels;if(n)for(let e of Object.values(n)){if(!e||"object"!=typeof e)continue;for(let r of(a(e),["subscribe","publish","send","receive"])){let t=e[r];t&&"object"==typeof t&&(a(t),a(t.message))}let r=e.messages;if(r)for(let e of Object.values(r))a(e)}let o=e.operations;if(o)for(let e of Object.values(o))a(e);let s=e.components;if(s){for(let e of["messages","messageTraits"]){let r=s[e];if(r)for(let e of Object.values(r))a(e)}let e=s.schemas;if(e)for(let r of Object.values(e))a(r);let r=s.channels;if(r)for(let e of Object.values(r))a(e);let t=s.operations;if(t)for(let e of Object.values(t))a(e)}return[...t]}(r,t.prefixStartsWith))a[e]||(a[e]=x(e,void 0,t))}return a}(C,R,I);return{...r,extensions:{...e,...r?.extensions??{}}}},[r,T,C,R,I]),U=(0,n.useMemo)(()=>T?function(e){function r(r){let t=Object.entries(l.rootFields);if(!t.length)return null;let a=t.flatMap(([r,t])=>{let a=l.configs.find(e=>e.extensions?.[r])??l.configs.find(e=>e.prefixStartsWith&&r.startsWith(e.prefixStartsWith))??e[0];if(!a)return[];let o=a.extensions?.[r];return[(0,n.createElement)(x(r,o,a),{key:r,propertyName:r,propertyValue:t,document:void 0,parent:void 0})]});return a.length?(0,n.createElement)("div",null,...a):null}return{name:"sap-root-extensions",version:"1.0.0",install(e){e.registerComponent(i.PluginSlot.INFO,r)}}}(C):null,[T,C]),F=`[data-renderer-id="${P}"]`,L=`${F} { container: asyncapi-attrs / inline-size; height: 100%; overflow: auto; scrollbar-gutter: stable; }
${F} :where(h1,h2,h3,h4,p,span,strong,a,li,td,div):not(pre *) { overflow-wrap: anywhere; }`;return(0,s.jsxs)("div",{"data-renderer-id":P,className:o,children:[M&&(0,s.jsx)("style",{children:M}),T&&(0,s.jsx)("style",{children:v}),(0,s.jsx)("style",{children:L}),T&&(0,s.jsx)("style",{children:`[data-renderer-id="${P}"] #introduction .hidden { display: block !important; }`}),!T&&(0,s.jsx)("style",{children:`[data-renderer-id="${P}"] :is(#operations, #messages) div:has(> .flex.py-2 span.Extensions) { display: none; }`}),(0,s.jsx)(i,{schema:e,config:W,plugins:U?[U]:[]})]})}},64017(e,r,t){"use strict";t.d(r,{t:()=>p});var a=t(92810),n=t(96540),o=t(74848),s=t(90580),i=`
.csn-root {

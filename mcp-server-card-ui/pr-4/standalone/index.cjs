 ...
 * Usage with Express:
 * ```javascript
 * const { getAbsoluteFSPath } = require('@open-resource-discovery/mcp-server-card-ui/standalone');
 * const express = require('express');
 * const app = express();
 *
 * // Serve standalone files at /mcp-server-card-ui
 * app.use('/mcp-server-card-ui', express.static(getAbsoluteFSPath()));
 * ```
 */

...
Final paragraph with **bold text** and \`inline code\`.`,clampLines:3}},c={args:{text:'Here is some code:\n\n```javascript\nconst hello = "world";\nconsole.log(hello);\n```\n\nAnd an inline `code snippet`.'}},l=[`Default`,`WithClamp`,`CodeBlock`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...c.parameters?.docs?.source}}}}))();export{c as CodeBlock,o as Default,s as WithClamp,l as __namedExportsOrder,a as default};
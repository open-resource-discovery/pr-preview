...
export interface SquaresButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, "value" | "children" | "onCopy">, Pick<ButtonProps, "variant" | "size"> {
 ...
 */
declare const SquaresButton: ForwardRefExoticComponent<SquaresButtonProps & RefAttributes<HTMLButtonElement>>;
export { SquaresButton };
//# sourceMappingURL=SquaresButton.d.ts.map
...
export interface TwoFaceButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, "value" | "children" | "onCopy">, Pick<ButtonProps, "variant" | "size"> {
 ...
 */
declare const TwoFaceButton: ForwardRefExoticComponent<TwoFaceButtonProps & RefAttributes<HTMLButtonElement>>;
export { TwoFaceButton };
//# sourceMappingURL=TwoFaceButton.d.ts.map